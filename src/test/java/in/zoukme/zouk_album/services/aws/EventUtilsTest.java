...
class EventUtilsTest {
  ...
  void getEventFolderNameWithAcent() {
    ...
    Assertions.assertThat(eventFolderName).isEqualTo("next-events/forro-sunset-2026");
  }
  ...
  void getEventFolderNameWithTil() {
    ...
    Assertions.assertThat(eventFolderName).isEqualTo("next-events/conexao-bc-2026");
  }

  @Test
  void getEventFolderName() {
    var eventFolderName = EventUtils.getEventFolderName("Elite Samba Congress 2025");
    Assertions.assertThat(eventFolderName).isEqualTo("next-events/elite-samba-congress-2025");
  }
