...
VALUES (1, 'ConecSamba 2025', 'ConecSamba é um dos maiores congressos de samba do Paraná', '2025-04-11', 'Curitiba/PR', '/next-events/conecsamba2025.jpg', 'conecsamba-2025');

INSERT INTO events(id, title, description, date, location, cover_url, event_url)
VALUES (2, 'ConecZouk 2025', 'ConecZouk - Gerações do zouk conectando o mundo', '2025-09-12', 'Curitiba/PR', '/next-events/coneczouk2025.jpg', 'coneczouk-2025');

INSERT INTO events(id, title, description, date, location, cover_url, event_url)
VALUES (3, 'Elite Samba Congress 2025', 'Elite Samba Congress - Nosso SAMBA é INFINITO!', '2025-08-15', 'Balneário Camboriú/SC', '/next-events/elitesambacongress2025.jpg', 'elitesamba-congress-2025');
