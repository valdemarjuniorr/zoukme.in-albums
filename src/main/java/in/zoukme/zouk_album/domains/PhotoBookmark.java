...
@Table("photo_bookmarks")
public record PhotoBookmark(@Id Long id, AggregateReference<Photo, Long> eventPhotoId,
    AggregateReference<User, Long> userId,
    LocalDateTime createdAt) {

  public PhotoBookmark(Long eventPhotoId, Long userId) {
